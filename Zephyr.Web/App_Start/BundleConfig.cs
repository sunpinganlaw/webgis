    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Content/js/library").Include(
                ...
                "~/Content/js/core/magicodes.echart.js",
                "~/Content/js/jquery-plugin/echart/echarts.js",
                "~/Content/js/jquery-plugin/echart/theme/macarons.js",
                 "~/Content/js/echarts/echarts.js",
                "~/Content/js/echarts/echarts.common.js",
                //"~/Content/js/core/knockout-3.4.2.js",
                // "~/Content/js/core/knockout.mapping-2.4.1.js",
                //"~/Content/js/core/knockout.bindings.js",

...
{
    [Module("Mms")]
    public class mms_drainpipeService : ServiceBase<mms_drainpipe>
    {
        //插入ProjectCode
        ...
        public dynamic GetCountByGroupName(string name)
        {
            ...
            string sSql = string.Format(@"Select count(*) as countnumber,{0} from mms_drainPipe where {1} is not null  group by {2} ", name, name, name);
    ...
    public class mms_drainpipe : ModelBase
     {

...
namespace Zephyr.Models
{
    public class sys_codeService : ServiceBase<sys_code>
    {
        ...
        public List<dynamic> Decode(string codeType)
        {
            var pQuery = ParamQuery.Instance()
        ...
        public string GetDefaultCodeNew(string sType)
        {
            var pQuery = ParamQuery.Instance().Select("top 1 Value")
                .AndWhere("CodeType", sType)
                .AndWhere("IsEnable", true)
                .AndWhere("IsDefault", true);
        ...
        public string GetTextByCode(string value, string sType)
        {
            var pQuery = ParamQuery.Instance().Select("top 1 Text")
                .AndWhere("CodeType", sType)
